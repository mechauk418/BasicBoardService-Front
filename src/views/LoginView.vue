...
export default {
  ...
  methods:{
    ...
    kakaologin() {
      ...
      const KAKAO_REDIRECT_URI = 'https://basic-board-service-front.vercel.app/login'
    ...
    googlelogin() {
      ...
      const GOOGLE_CALLBACK_URI= 'https://basic-board-service-front.vercel.app/login'
