  ...
  <div>
    ...
    <div class="article_box">
      ...
      <div v-for="image in article_image" :key="image">
        <img :src="image.image_original" v-if="image.image == null"  style="position: absolute; width:60%;">
        <img :src="image.image" v-else  style="position: absolute; width:60%;">
      </div>
...
export default {
  ...
  methods: {
    ...
    create_comment() {
      ...
      testaxios.post('https://www.rollthun.site/articles/' + `${this.$route.params.pk}/comment/`, comment_data)
          .then((response) => {
